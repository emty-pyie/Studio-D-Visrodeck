...
.ws-card{width:100%;max-width:500px;background:#111113;border:1px solid #2a2a2e;border-radius:6px;overflow:hidden;-webkit-app-region:no-drag;}
.ws-hdr{display:flex;align-items:center;justify-content:space-between;padding:16px 22px;border-bottom:1px solid #1e1e22;}
...
.ws-iicon{position:absolute;left:10px;font-size:12px;color:#333;pointer-events:none;}
...
.ws-err{font-family:'JetBrains Mono',monospace;font-size:10px;color:#e05c5c;padding:6px 10px;background:rgba(224,92,92,.06);border:1px solid rgba(224,92,92,.2);border-radius:2px;margin-bottom:10px;}
...
.ws-browse{background:transparent;color:#666;border-color:#2a2a2e;}
.ws-browse:hover:not(:disabled){color:#e2e2e2;border-color:#444;}
.ws-open{background:#fff;color:#0a0a0b;border-color:#fff;font-size:12px;padding:10px 20px;}
.ws-open:hover:not(:disabled){background:#d4d4d4;border-color:#d4d4d4;}
.ws-info{display:flex;align-items:center;gap:6px;margin-top:16px;font-family:'JetBrains Mono',monospace;font-size:9px;color:#2a2a2e;}
